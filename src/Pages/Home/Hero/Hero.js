            ...
            <div className=' max-w-6xl mx-auto lg:pt-16 pt-8 px-5 sm:px-9 md:px-12 lg:px-16 xl:px-0'>
                <div className=' flex flex-col lg:flex-row justify-between lg:relative'>
                    <div className='lg:w-[40%] lg:mr-8'>
                        ...
                        <p className=' text-sm text-[#b2b2b2] leading-7 my-6'>The weather may be cool but the shopping is hot. See an edit of the pieces our curators are loving right this minute.</p>
                        <div>
                            <button className='btn btn-secondary normal-case rounded-full'>Shop Now</button>
                            <button className='btn btn-outline border-white text-white normal-case rounded-full ml-4'>Explore</button>
                        </div>
                    </div>
